...
function ns_head() {
	echo '<script type="text/javascript" src="'.get_template_directory_uri().'/js/sfhover.js"></script>';
}

add_action('wp_head', 'ns_head');
...
function kubrick_add_theme_page() {
	...
	add_theme_page(__('Customize Header'), __('Header Image and Colors'), 'edit_themes', basename(__FILE__), 'kubrick_theme_page');
}
