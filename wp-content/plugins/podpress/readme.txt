...
Version 8.8.1 is temporary maintenance release to make podPress compatible with the post revisions feature introduced in WordPress 2.6. 
If somebody is interested in maintaining podPress while the main developers are out or in submitting a patch, 
please email Andrew on admin [at] laptoptips.ca.
