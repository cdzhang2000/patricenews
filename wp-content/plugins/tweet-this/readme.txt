...
Can automatically tweet new blog posts. Highly customizable.

== Description ==

Adds a "Tweet This Post" link to every post and page. Shortens URLs.
Can automatically tweet new blog posts. Customizable (check screenshots).
Also included: Plurk, Yahoo Buzz, Delicious, Digg, Facebook, MySpace,
Ping.fm, Reddit, and StumbleUpon.

`Version 1.6 makes these changes:
...
appears when writing a new post.
...
In the options menu, there is a section titled "Import / Export Options."
This is as simple as can be: the export is a raw dump of the
`tweet_this_settings` row from the `wp_options` table, and to import, you just
paste that dump in the import text area. Click "Import Options," and your
current options will be replaced. Your Twitter password is NOT included
in the exported options.
