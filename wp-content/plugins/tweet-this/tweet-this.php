...
Description: Adds a "Tweet This Post" link to every post and page. Shortens URLs. Can automatically tweet new blog posts. Highly customizable.
...
/**
 * This is Tweet This v1.6, build 024, 2009-08-24.
 */
...
function tt_post_options() {
	...
	elseif($post->post_status == 'private')
		...
		elseif(tt_option('tt_auto_tweet_text') != '')
			echo	tt_option('tt_auto_tweet_text');
 ...
 * Settings > Tweet This (default is unchecked). These ads pull in $50 a month
 * for me, paying half the hosting bill for my URL shortening service, Th8.us,
 * and my blog.
 */
